...
def autoSmoothContoursOfCharacter(grayscale, bitmap_threshold=127, dist_threshold=30, max_error=200,
    ...
    for comp in components:
        ...
        comp_smoothed = autoSmoothContoursOfComponent(comp, dist_threshold, max_error, blockSize, ksize, k)
...
def autoSmoothContoursOfComponent(component, dist_threshold=30, max_error=200, blockSize=3, ksize=3, k=0.04):
    """
